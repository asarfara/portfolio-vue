<template>
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    <div id="profile"
      ...
      <div class="p-4 md:p-12 text-center lg:text-left">
        <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
             :style="{ backgroundImage: 'url(/img/face.png)' }"></div>
        <h1 class="text-3xl font-bold pt-8 lg:pt-0">Ali Sarfaraz</h1>
        ...
        <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
          <svg class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            <path
              d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"></path>
          </svg>
          Web Developer
        </p>
        ...
        <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
          ...
          <a class="link" href="https://github.com/asarfara" data-tippy-content="@github_handle">
            <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                 xmlns="http://www.w3.org/2000/svg">
              <title>GitHub</title>
              <path
          ...
          <a class="link" href="https://www.linkedin.com/in/ali-sarfaraz/" data-tippy-content="@linkedin_handle">
            <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                 xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="w-full lg:w-2/5">
      <img src="/img/face.png" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
    </div>
  </div>
</template>
